...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: title(), backgroundColor: Colors.grey, body: body(context));
  }
        ...
        children: <Widget>[
          Column(
              ...
              children: <Widget>[
                ...
                pad(
                    row(
                        txt('Credito Limite', 17.5, Colors.white,
                            FontWeight.w500),
                ...
                row(
                    pad(
                        txt('Nacionalidade BR', 20, Colors.white,
                            FontWeight.normal),
                        0,
                        0,
                        10,
  ...
  but(BuildContext context) {
    return ElevatedButton(
      child: txt('Confirmar', 20, Colors.blueGrey, FontWeight.normal),
      style: ButtonStyle(
