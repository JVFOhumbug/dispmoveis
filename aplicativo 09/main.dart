...
class _HomeState extends State<Home> {
  ...
  col(name, double L, double T, double R, double B) {
    return Column(
        ...
        children: <Widget>[
          p(t(name, 25, Colors.green), L, T, R, B),
          p(t('Salário: R\$ xxxxx.xx', 20, Colors.red), 0, 5, 115, 0),
          p(t('Descrição:----------------------', 20, Colors.red), 5, 5, 10, 0),
          p(t('Contato: (XX) XXXXX-XXXX', 20, Colors.red), 0, 5, 35, 0),
        ]);
  }
}
