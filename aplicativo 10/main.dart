...
class _HomeState extends State<Home> {
  ...
  body() {
    return SingleChildScrollView(
      ...
      children: <Widget>[
        //L T R B
        padding(
            row(padding(text('Valor:', 30, Colors.white), 30, 0, 0, 0),
            ...
            10),
        Row(children: <Widget>[
          padding(text('De:', 30, Colors.white), 30, 0, 0, 0),
          padding(dropdown_from(), 10, 0, 0, 0),
          padding(text('Para:', 30, Colors.white), 40, 0, 0, 0),
  ...
  anim_container() {
    return AnimatedContainer(
        ...
        child: Center(child: text('$to $ans', 30, Colors.purple)));
  }
