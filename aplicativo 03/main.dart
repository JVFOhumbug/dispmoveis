...
_Construct(var1, var2, var3, class1) {
  return Scaffold(
    appBar: AppBar(title: _Title(), backgroundColor: Colors.purple),
...
_Body(var1, var2, var3, class1) {
  return SingleChildScrollView(
      ...
      child: Column(
          ...
          children: <Widget>[
            _Field('Insira número', var1),
            _Field('Insira número', var2),
            _Button(class1),
            _Text(var3)
          ]));
}
...
_Field(InputText, objControll) {
  return TextField(
    ...
    decoration: InputDecoration(
        labelText: InputText, labelStyle: TextStyle(color: Colors.grey)),
...
// ignore: non_constant_identifier_names
_Text(fin) {
  return Text('$fin', style: TextStyle(color: Colors.white, fontSize: 30));
}
